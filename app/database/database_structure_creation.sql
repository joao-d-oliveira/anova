-- SQL Script to transform database structure
-- This script drops all existing tables and creates new ones according to DB_STRUCTURE.md

-- Drop existing tables (in reverse order of dependencies)
DROP TABLE IF EXISTS reports;
DROP TABLE IF EXISTS game_simulations;
DROP TABLE IF EXISTS team_analysis;
